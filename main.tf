...
module "rbac" {
  source = "github.com/cloud-native-toolkit/terraform-gitops-rbac.git?ref=provider"
...
module "sccs" {
  source = "github.com/cloud-native-toolkit/terraform-gitops-sccs.git?ref=provider"
  depends_on = [gitops_module.module]
